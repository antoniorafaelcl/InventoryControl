package com.antoniorafaelcl.InvetoryControl;
...
import com.antoniorafaelcl.InvetoryControl.repositories.ProdutoRepository;

@SpringBootApplication
public class InvetoryControlApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(InvetoryControlApplication.class, args);
	}
